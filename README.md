...
<!-- RECENT-REPOS:START -->
- **[pandastack](https://github.com/panda850819/pandastack)** — Public personal stack content (skills, agents, personal contexts) for pdctx framework. Renamed from pstack 2026-04-29. <sub>2026-06-19</sub>
...
<!-- RECENT-PRS:START -->
- [feat: coding-agent autonomy Wave A — real verify gate + acceptance lanes (PRO-30)](https://github.com/panda850819/pandastack/pull/16) — `panda850819/pandastack` <sub>open · 2026-06-19</sub>
- [feat(checkpoint): tailor baton with suggested-skills + reference rule + redaction (PRO-31)](https://github.com/panda850819/pandastack/pull/15) — `panda850819/pandastack` <sub>open · 2026-06-19</sub>
- [feat: add pandastack doctor and capability map](https://github.com/panda850819/pandastack/pull/14) — `panda850819/pandastack` <sub>merged · 2026-06-18</sub>
