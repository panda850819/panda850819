...
<!-- RECENT-REPOS:START -->
- **[murmur](https://github.com/panda850819/murmur)** — Voice → text dictation for macOS+iOS. Personal dogfood + practice repo. Successor to panda850819/murmur-voice (Tauri/Rust). Hard kill 2026-08-11 if no iOS TestFlight. <sub>2026-05-14</sub>
...
<!-- RECENT-PRS:START -->
- [chore(build): bottle Xcode bootstrap recipe + CI xcodebuild path](https://github.com/panda850819/murmur/pull/1) — `panda850819/murmur` <sub>open · 2026-05-14</sub>
